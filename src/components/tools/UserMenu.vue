...
<script>
  ...
  export default {
    ...
    /* TODO-END-DESC：做头部菜单栏导航*/
    watch: {
      // TODO-START-DESC：菜单搜索改为动态组件，在手机端呈现出弹出框
      device: {
        immediate: true,
        handler() {
      ...
      // TODO-END-DESC：菜单搜索改为动态组件，在手机端呈现出弹出框
    },
    methods: {
      /* TODO-START-DESC： 做头部菜单栏导航*/
      showClick() {
