...
<script>
  ...
  import HTreeSelect from '@/components/assem/HTreeSelect'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: '/api-platf/platform/category/add',
          edit: '/api-platf/platform/category/edit',
          checkCode: '/api-platf/platform/category/checkCode'
        },
        expandedRowKeys: [],
        pidField: 'pid'
