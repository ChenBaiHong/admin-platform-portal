...
<script>
  ...
  import UserModal from '../user-manage/UserModal'
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: "/api-platf/platform/user/departUserList",
          edit: "/api-platf/platform/user/editSysDepartWithUser",
          delete: "/api-platf/platform/user/deleteUserInDepart",
          deleteBatch: "/api-platf/platform/user/deleteUserInDepartBatch",
        }
      }
    },
    created() {
