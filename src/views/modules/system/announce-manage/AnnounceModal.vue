        ...
        <a-row style="width: 100%;">
          <a-col :span="24/2">
            <a-form-item
              ...
              :wrapperCol="wrapperCol"
              label="开始时间:">
              <h-date style="width: 100%" :getCalendarContainer="node => node.parentNode"
                      v-decorator="[ 'startTime', validatorRules.startTime]" placeholder="请选择开始时间" showTime
                      dateFormat="YYYY-MM-DD HH:mm:ss"></h-date>
            </a-form-item>
          </a-col>
          <a-col :span="24/2">
            <a-form-item
        ...
        <a-row style="width: 100%;">
          <a-col :span="24">
            <a-form-item
              ...
              <h-editor v-decorator="[ 'msgContent', {} ]" triggerChange></h-editor>
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
...
<script>
  ...
  import HDate from '@/components/assem/HDate'
  import HEditor from '@/components/assem/HEditor'
  import SelectUserListModal from './SelectUserListModal'
  import moment from 'moment'

  export default {
    components: { HEditor, HDate, SelectUserListModal },
    name: 'AnnounceModal',
    data () {
      return {
        title: '操作',
        ...
        url: {
          queryByIds: '/api-platf/platform/user/queryByIds',
          add: '/api-platf/platform/annountCement/add',
          edit: '/api-platf/platform/annountCement/edit',
        },
        userType: false,
        userIds: [],
        selectedUser: [],
